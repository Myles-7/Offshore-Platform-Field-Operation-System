...
/**
 * work_order_record_detail 表实体。
 * 根据 db/init_schema.sql 生成。
 */
public class WorkOrderRecordDetail {
    public static final String TABLE_NAME = "work_order_record_detail";
    ...
    private Integer attachmentRefFlag;
    private Integer aiRefFlag;
    ...
    public Integer getAttachmentRefFlag() {
        return attachmentRefFlag;
    }

    public void setAttachmentRefFlag(Integer attachmentRefFlag) {
        this.attachmentRefFlag = attachmentRefFlag;
    }

    public Integer getAiRefFlag() {
        return aiRefFlag;
    }

    public void setAiRefFlag(Integer aiRefFlag) {
        this.aiRefFlag = aiRefFlag;
    }
