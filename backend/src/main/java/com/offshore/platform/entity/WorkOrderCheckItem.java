...
/**
 * work_order_check_item 表实体。
 * 根据 db/init_schema.sql 生成。
 */
public class WorkOrderCheckItem {
    public static final String TABLE_NAME = "work_order_check_item";
    ...
    public Integer getAttachmentRequiredFlag() {
        return attachmentRequiredFlag;
    }

    public void setAttachmentRequiredFlag(Integer attachmentRequiredFlag) {
    ...
    public Integer getAiRequiredFlag() {
        return aiRequiredFlag;
    }

    public void setAiRequiredFlag(Integer aiRequiredFlag) {
        this.aiRequiredFlag = aiRequiredFlag;
    }
