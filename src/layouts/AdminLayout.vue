<template>
  <el-container class="admin-layout">
    <el-aside class="admin-layout__aside" :width="appStore.sidebarCollapsed ? '64px' : '232px'">
      <div class="admin-layout__brand">
        <el-icon><Ship /></el-icon>
        <span v-if="!appStore.sidebarCollapsed">现场作业管理</span>
      </div>
      <AppMenu :collapsed="appStore.sidebarCollapsed" />
    </el-aside>
    <el-container>
